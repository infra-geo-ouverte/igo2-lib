import { Action, EntityStoreFilterCustomFuncStrategy, EntityStoreFilterSelectionStrategy, Widget } from '@igo2/common';
    ...
    const actions = [
        {
            ...
            handler: () => {
                ...
                storageService.set('zoomAuto', !storageService.get('zoomAuto') as boolean);
            }
        },
        {
        ...
        },
        {
            ...
            args: [workspace],
            availability: (ws: FeatureWorkspace | WfsWorkspace | EditionWorkspace) => noElementSelected(ws)
        },
        {
            id: 'featureDownload',
            icon: 'file-export',
        ...
        },
        {
            ...
            handler: (widget: Widget, ws: FeatureWorkspace | WfsWorkspace | EditionWorkspace) => {
