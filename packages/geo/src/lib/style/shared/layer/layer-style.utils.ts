...
import { AnyOlStyle, LayerStyle } from './layer-style.interface';
...
export function isAnyOlStyle(obj: any): obj is AnyOlStyle {
  if (!obj) return false;
...
export function LayerQueryResultsOlStyleFunction(
  ...
  return LayerSearchResultsOlStyleFunction(viewController, type);
}
