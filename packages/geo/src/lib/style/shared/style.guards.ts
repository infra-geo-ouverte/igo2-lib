...
import type { StyleEngineKind } from './style.enum';
import type { EngineLayerStyle } from './style.interface';
...
export function hasLayerStyleType<TType extends StyleEngineKind>(
  value: unknown,
  type: TType
): value is EngineLayerStyle<TType, unknown> {
  return isRecord(value) && value['type'] === type;
}

export function isEngineLayerStyle(
  value: unknown
): value is EngineLayerStyle<StyleEngineKind, unknown> {
