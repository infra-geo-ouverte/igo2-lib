...
export class ModifyControl {
  ...
  private activateModifyInteraction() {
    ...
    this.onModifyEndKey = this.olModifyInteraction?.on('modifyend', (event) =>
  ...
  private deactivateModifyInteraction() {
    ...
    if (this.olMap !== undefined && this.olModifyInteraction !== undefined) {
  ...
  private activateTranslateInteraction() {
    ...
    if (this.olTranslateInteraction) {
  ...
  private deactivateTranslateInteraction() {
    ...
    if (this.olMap !== undefined && this.olTranslateInteraction !== undefined) {
  ...
  private subscribeToDrawKeyDown() {
    this.drawKeyDown$$ = fromEvent<KeyboardEvent>(
      document,
      'keydown'
    ).subscribe((event) => {
  ...
  private subscribeToDrawKeyUp() {
    this.drawKeyUp$$ = fromEvent<KeyboardEvent>(document, 'keyup').subscribe(
      (event) => {
        if (event.key !== 'Control') {
          return;
        }
  ...
  private removeOlDrawInteraction() {
    ...
    this.deactivateDrawInteraction();
    this.clearOlLinearRingsSource();
    this.olDrawInteraction = undefined as unknown as OlDraw;
  }
  ...
  private deactivateDrawInteraction() {
    ...
    if (this.olMap !== undefined && this.olDrawInteraction !== undefined) {
  ...
  private onDrawEnd(event: OlDrawEvent) {
    ...
    const linearRingCoordinates = (event.feature.getGeometry() as any)
      .getLinearRing()
      .getCoordinates();
   ...
   * @returns OL Geometry
   */
  private getOlGeometry(): OlGeometry | undefined {
