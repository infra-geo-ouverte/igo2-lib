...
export class WFSDataSourceService extends DataService {
  ...
  public buildBaseWfsUrl(
    ...
    // if (
    //   wfsDataSourceOptions.version === '2.0.0' ||
    //   !wfsDataSourceOptions.version
    // ) {
    //   paramTypename = 'typenames';
    // }
    // const baseWfsQuery = 'service=wfs&request=' + wfsQuery;
    // const wfs_typeName =
    //   paramTypename + '=' + wfsDataSourceOptions.featureTypes;
    // const wfsVersion = wfsDataSourceOptions.version
    //   ? 'version=' + wfsDataSourceOptions.version
    //   : 'version=' + '2.0.0';
    //
    // return `${
  ...
  public wfsGetFeature(
    ...
    //   ? 'srsname=' + wfsDataSourceOptions.srsname
    ...
    //     ? paramMaxFeatures + '=' + wfsDataSourceOptions.maxFeatures
    //     : paramMaxFeatures + '=' + nb;
    // }
  ...
  private built_properties_value(features: olFeature[]) {
